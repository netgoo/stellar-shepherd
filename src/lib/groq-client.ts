// ============================================================
// Groq API Client - Generate email replies
// v4.1.1: Fixed AI_REPLY_TIMEOUT_MS import in generateWithPrompt.
// ============================================================
import { AI_SYSTEM_PROMPT, MAX_EMAIL_BODY_LENGTH, AI_REPLY_TIMEOUT_MS } from '../config/reply-config';
